...
Documentation can be found in the `.\docs\` directory. The theory and algorithm of the code is explained in a journal article (to be submitted for review soon)
